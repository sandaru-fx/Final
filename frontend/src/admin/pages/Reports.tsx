    ...
    <div className="flex flex-col h-full relative">
      ...
      <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6 mb-8">
        ...
        <div className="flex gap-4 overflow-x-auto pb-2 w-full xl:w-auto custom-scrollbar">
          <div className="glass-panel min-w-[160px] flex-1 xl:flex-initial rounded-xl p-4 flex flex-col gap-1 hover:border-[#7f13ec]/50 transition-colors cursor-pointer group">
            <div className="flex justify-between items-start">
              <p className="text-[#ad92c9] text-xs font-medium uppercase tracking-wider">Pending</p>
              <span className="material-symbols-outlined text-yellow-400 text-lg group-hover:scale-110 transition-transform">pending_actions</span>
            </div>
          ...
          <div className="glass-panel min-w-[160px] flex-1 xl:flex-initial rounded-xl p-4 flex flex-col gap-1 hover:border-[#7f13ec]/50 transition-colors cursor-pointer group">
            <div className="flex justify-between items-start">
              <p className="text-[#ad92c9] text-xs font-medium uppercase tracking-wider">Banned Today</p>
              <span className="material-symbols-outlined text-red-400 text-lg group-hover:scale-110 transition-transform">block</span>
            </div>
            <p className="text-2xl font-bold text-white mt-1">5</p>
            <p className="text-[#ad92c9] text-xs font-medium">vs 3 yesterday</p>
          </div>
          
          <div className="glass-panel min-w-[160px] flex-1 xl:flex-initial rounded-xl p-4 flex flex-col gap-1 hover:border-[#7f13ec]/50 transition-colors cursor-pointer group">
            <div className="flex justify-between items-start">
              <p className="text-[#ad92c9] text-xs font-medium uppercase tracking-wider">Response Time</p>
              <span className="material-symbols-outlined text-blue-400 text-lg group-hover:scale-110 transition-transform">timer</span>
            </div>
            <p className="text-2xl font-bold text-white mt-1">2m 30s</p>
            <p className="text-green-400 text-xs font-medium">-15% improvement</p>
          </div>
        </div>
      </div>

      {/* Controls: Search & Filter */}
      <div className="mb-8 flex flex-col md:flex-row gap-4 items-center justify-between glass-panel p-2 rounded-2xl">
        {/* Search */}
      ...
      <div className="flex-1 overflow-y-auto z-10 px-2 pb-6 custom-scrollbar">
        <div className="max-w-4xl mx-auto relative">
          ...
          <div className="absolute left-6 top-4 bottom-0 w-0.5 bg-gradient-to-b from-[#7f13ec] via-[#4d3267] to-transparent opacity-50"></div>
          ...
          <div className="relative pl-16 mb-8 group">
            <div className="glass-panel bg-gradient-to-br from-[#362348]/40 to-[#1a1122]/40 rounded-2xl p-6 transition-all duration-300 hover:translate-x-2 hover:shadow-[0_0_10px_rgba(127,19,236,0.3)] hover:border-[#7f13ec]/40">
              <div className="flex flex-col md:flex-row gap-6">
                ...
                <div className="shrink-0 flex md:flex-col items-center md:items-start gap-3 md:w-48 border-b md:border-b-0 md:border-r border-white/10 pb-4 md:pb-0 md:pr-4">
                  <div className="relative">
                    <img src="https://images.unsplash.com/photo-1552053831-71594a27632d?auto=format&fit=crop&w=150&q=80" alt="Dog" className="size-14 rounded-xl object-cover" />
                ...
                <div className="flex-1 flex flex-col gap-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <span className="px-3 py-1 rounded-full bg-red-500/10 text-red-400 border border-red-500/20 text-xs font-bold uppercase tracking-wide">High Severity</span>
                  ...
                  <div className="flex gap-2 mt-1">
                     <div className="h-16 w-24 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center cursor-pointer hover:bg-white/10 transition-colors">
            ...
            {/* Timeline Connector Circle (Small) */}
          ...
          <div className="relative pl-16 mb-8 group">
            <div className="glass-panel bg-gradient-to-br from-[#362348]/40 to-[#1a1122]/40 rounded-2xl p-6 transition-all duration-300 hover:translate-x-2 hover:border-[#7f13ec]/40">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="shrink-0 flex md:flex-col items-center md:items-start gap-3 md:w-48 border-b md:border-b-0 md:border-r border-white/10 pb-4 md:pb-0 md:pr-4">
                  <div className="relative">
          ...
          <div className="relative pl-16 mb-8 mt-12">
            <div className="absolute left-0 top-1 w-12 text-right">
          ...
          {/* Card 3: Low Severity */}
          <div className="relative pl-16 mb-8 group opacity-80 hover:opacity-100 transition-opacity">
            <div className="glass-panel bg-gradient-to-br from-[#362348]/40 to-[#1a1122]/40 rounded-2xl p-6 transition-all duration-300 hover:translate-x-2">
              <div className="flex flex-col md:flex-row gap-6">
                <div className="shrink-0 flex md:flex-col items-center md:items-start gap-3 md:w-48 border-b md:border-b-0 md:border-r border-white/10 pb-4 md:pb-0 md:pr-4">
                  <div className="relative">
