    ...
    <div className="max-w-6xl mx-auto space-y-6">
      ...
      <div className="glass-panel rounded-2xl p-6 lg:p-8 flex flex-col md:flex-row gap-6 items-center md:items-start relative overflow-hidden group">
        ...
        <div className="flex-1 text-center md:text-left z-10">
          <h2 className="text-3xl font-bold text-white mb-1">Alex Mercer</h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
        ...
        <div className="lg:col-span-3 space-y-6">
            ...
            <div className="glass-panel rounded-2xl p-6 md:p-8 animate-fadeIn">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input type="text" defaultValue="Alex" className="w-full bg-[#191022] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#7f13ec] focus:ring-1 focus:ring-[#7f13ec] transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-gray-400 text-xs font-bold uppercase tracking-wider ml-1">Last Name</label>
                  <input type="text" defaultValue="Mercer" className="w-full bg-[#191022] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#7f13ec] focus:ring-1 focus:ring-[#7f13ec] transition-all" />
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input type="email" defaultValue="alex.mercer@pawmate.com" className="w-full bg-[#191022] border border-white/10 rounded-xl pl-10 pr-4 py-3 text-white focus:outline-none focus:border-[#7f13ec] focus:ring-1 focus:ring-[#7f13ec] transition-all" />
                  </div>
                </div>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input type="tel" defaultValue="+1 (555) 000-0000" className="w-full bg-[#191022] border border-white/10 rounded-xl pl-10 pr-4 py-3 text-white focus:outline-none focus:border-[#7f13ec] focus:ring-1 focus:ring-[#7f13ec] transition-all" />
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="glass-panel rounded-2xl p-6 md:p-8 animate-fadeIn">
              ...
              <div className="space-y-4 mb-8">
                 <div className="space-y-2">
                    ...
                    <input type="password" defaultValue="********" className="w-full bg-[#191022] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#7f13ec] transition-all"/>
                 </div>
                 <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                       <label className="text-gray-400 text-xs font-bold uppercase tracking-wider ml-1">New Password</label>
                       <input type="password" placeholder="Enter new password" className="w-full bg-[#191022] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#7f13ec] transition-all"/>
                    </div>
                    <div className="space-y-2">
                       <label className="text-gray-400 text-xs font-bold uppercase tracking-wider ml-1">Confirm New Password</label>
                       <input type="password" placeholder="Confirm new password" className="w-full bg-[#191022] border border-white/10 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-[#7f13ec] transition-all"/>
                    </div>
                 </div>
              </div>
          ...
          <div className="flex items-center justify-end gap-4 pt-2">
            ...
            <button className="px-8 py-3 rounded-xl bg-[#7f13ec] hover:bg-[#6d0ecb] text-white shadow-lg shadow-[#7f13ec]/30 transition-all font-bold tracking-wide transform hover:-translate-y-0.5">Save Changes</button>
          </div>
        </div>
      </div>
    </div>
